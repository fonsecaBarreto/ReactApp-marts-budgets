        ...
        <LoginFormGrid columns={[]}>
                ...
                <LoginFormRow label="Pessoa responsável *" error={errors?.['responsible_name']} >
                    <input type={'text'} placeholder="Exemplo: Lucas Fonseca"
                        value={responsible_name} onInput={e=>handleInputs('responsible_name', e.target.value)} >
                    </input>
                </LoginFormRow>

                <LoginFormRow label="CNPJ ou CPF *" error={errors?.['cnpj_cpf']} >
                    <input type={'text'} placeholder="Exemplo: 99.999.999/9999-99"
